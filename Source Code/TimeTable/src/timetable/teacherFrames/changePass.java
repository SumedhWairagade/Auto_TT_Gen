...
public class changePass extends javax.swing.JFrame {
    ...
    String teacherName,currentPass,newPass,reenterPass,password;
    ...
    private void checkPassword(String name){
        try{
            ...
            convertPass();
            pst = conn.prepareStatement("select * from teachers where username = ? and college_id= ? and dept_id= ?");
            pst.setString(1, name);
            ...
            if(rs.next())
            {
                ...
                if(password.equals(currentPass)){
                    if(newPass.equals(reenterPass)){
                        pstUpdate = conn.prepareStatement("update teachers set password = ? where username=? and college_id= ? and dept_id= ? ");
