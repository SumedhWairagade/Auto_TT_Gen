...
public class editProfile extends javax.swing.JFrame {
    ...
    String teacherName,name1,position,department,college,email,getSelectedImage;
    ...
    private void searchTeacher(String name){
        try{
            
            PreparedStatement pst = null;
            pst = conn.prepareStatement("select * from teachers where username = ?");
    ...
    public void updateTeacher(String name){
        try{
            ...
            if( profilePicUpdated == 1){
                ...
                pst = conn.prepareStatement("update teachers set name = ?, position = ?, email_id = ?, profile_picture = ? where username = ? and college_id= ? and dept_id= ?");
                ...
                pst = conn.prepareStatement("update teachers set name = ?, position = ?, email_id = ? where username = ? and college_id= ? and dept_id= ?");
                pst.setString(1, name1);
                pst.setString(2, position);
    ...
    private void initComponents() {
        ...
        setTitle("AppName");
        setMaximumSize(new java.awt.Dimension(370, 551));
        setMinimumSize(new java.awt.Dimension(370, 551));
        setPreferredSize(new java.awt.Dimension(370, 551));
        setResizable(false);
        setSize(new java.awt.Dimension(370, 551));
        ...
        setSize(new java.awt.Dimension(393, 638));
