...
import timetable.Panels.adminHome;
...
import timetable.Panels.adminProfile;
/**
 *
 * @author Pritam Bera
 */
public class adminDashboard extends javax.swing.JFrame {
   ...
   private void setAdminName(String username){
        try{
            
            PreparedStatement pst = null;
            PreparedStatement pst2 = null;
            
            pst = conn.prepareStatement("select name,position,college_id,dept_id,profile_picture from admins where username = ?");
    ...
    public adminDashboard() {
        ...
        a1 = new adminHome(name);
        a2 = new adminProfile(name);
        a3 = new aboutUs();
        a4 = new contactUs();
    ...
    private void initComponents() {
        ...
        jPanel7.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 130, 40));
        ...
        setSize(new java.awt.Dimension(1073, 627));
